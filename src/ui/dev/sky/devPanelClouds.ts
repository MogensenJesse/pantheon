  ...
  const body = mountSection(panel, {
    ...
    body: `
      ...
      <details class="dev-subsection">
        ...
        <p class="dev-hint">Cast uses opaque sphere silhouettes (terrain-safe). Soft edges come from <strong>Shadows → PCF radius</strong>. Instances sort back-to-front for cleaner soft overlaps. Particle count / sphere segments need field rebuild or full reload.</p>

...
export const CLOUD_LAYOUT_SPECS: CloudSpec[] = [
  ...
  {
    id: 'dev-cloud-weather-cell',
    label: 'Weather cell (m)',
    min: 64,
    max: 512,
    step: 8,
    defaultValue: C.weather.cellM,
    format: (v) => v.toFixed(0),
    key: 'weatherCellM',
  },
  {
    id: 'dev-cloud-weather-octaves',
    label: 'Weather octaves',
    min: 1,
    max: 6,
    step: 1,
    defaultValue: C.weather.octaves,
    format: (v) => v.toFixed(0),
    key: 'weatherOctaves',
  },
  {
    id: 'dev-cloud-weather-softness',
    label: 'Weather softness',
    min: 0.02,
    max: 0.6,
    step: 0.01,
    defaultValue: C.weather.softness,
    format: (v) => v.toFixed(2),
    key: 'weatherSoftness',
  },
  {
    id: 'dev-cloud-weather-evolve',
    label: 'Weather evolve speed',
    min: 0,
    max: 0.1,
    step: 0.005,
    defaultValue: C.weather.evolveSpeed,
    format: (v) => v.toFixed(3),
    key: 'weatherEvolveSpeed',
  },
  {

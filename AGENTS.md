...
This project is indexed by GitNexus as **pantheon** (3783 symbols, 7332 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

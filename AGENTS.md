...
This project is indexed by GitNexus as **pantheon** (3759 symbols, 7268 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

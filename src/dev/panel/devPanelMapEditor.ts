// src/dev/panel/devPanelMapEditor.ts — map editor link + play-mode map switcher (DEV only)
import { populateMapListSelect } from '../../map/authoring/mapDomHelpers';
import { fetchMapManifest } from '../../map/MapIO';
import { getPlayMapId, setPlayMapId } from '../../map/play/playMapSelection';
...
export function initDevPanelMapEditor(panel: HTMLDivElement): () => void {
  const body = mountSection(panel, {
    ...
    open: false,
    body: `
      <p class="dev-hint">Play mode loads authored maps from <code>public/maps/</code>. Maps need <code>playerStart</code> (and orbs for gameplay). Reload after save or switch.</p>
      <label class="dev-row">
        <span>Play map</span>
      ...
      <div class="dev-actions">
        ...
        <a class="dev-link" href="/clouds.html" target="_blank" rel="noopener noreferrer">Open cloud designer</a>
      </div>

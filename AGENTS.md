...
This project is indexed by GitNexus as **pantheon** (2532 symbols, 6479 relationships, 205 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

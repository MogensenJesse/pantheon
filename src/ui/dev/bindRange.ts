// src/ui/dev/bindRange.ts — shared dev panel section/slider/checkbox helpers
export interface SectionSpec {
  /** Container id in DevPanelLayout shell (e.g. `dev-section-gameplay`). */
  hostId: string;
  /** `<summary>` text. */
  title: string;
  /** Default open state — match Phase 1 F14 / per-section design. */
  open: boolean;

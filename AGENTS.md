...
This project is indexed by GitNexus as **pantheon** (3925 symbols, 7848 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

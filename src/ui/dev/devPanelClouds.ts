...
const RING_FIELD_SPECS = [
  ...
  {
    key: 'staggeredClusters' as const,
    label: 'Staggered',
    id: 'stagger',
    min: 0,
    max: 48,
...
const GLOBAL_CLOUD_SPECS: GlobalCloudSpec[] = [
  {
    id: 'dev-cloud-night-alpha',
    label: 'Night visibility',
    min: 0.05,
    max: 0.5,
    step: 0.01,
    defaultValue: VISUAL.clouds.nightAlphaMul,
    format: (v) => v.toFixed(2),
    rebuild: false,
  },
  {
    id: 'dev-cloud-alpha-power',
    label: 'Night fade curve',
    min: 1,
    max: 4,
    step: 0.1,
    defaultValue: VISUAL.clouds.alphaPower,
    format: (v) => v.toFixed(2),
    rebuild: false,
  },
  {
    id: 'dev-cloud-color-threshold',
    label: 'Day color onset',
    min: 0.1,
    max: 0.6,
    step: 0.02,
    defaultValue: VISUAL.clouds.colorDayThreshold,
    format: (v) => v.toFixed(2),
    rebuild: false,
  },
  {
    id: 'dev-cloud-night-tint',
    label: 'Night tint darkness',
    min: 0,
    max: 1,
    step: 0.02,
    defaultValue: VISUAL.clouds.nightTintDarkness,
    format: (v) => v.toFixed(2),
    rebuild: false,
  },
  {
    id: 'dev-cloud-ring-rot',
    label: 'All rings rotation',
    min: 0,
    max: 360,
    step: 1,
    defaultValue: VISUAL.clouds.ringRotationDeg,
    format: (v) => `${Math.round(v)}°`,
    rebuild: true,
  },
  {
    id: 'dev-cloud-rot-jitter',
    label: 'Rotation jitter',
    min: 0,
    max: 2,
    step: 0.05,
    defaultValue: VISUAL.clouds.rotationJitter,
    format: (v) => v.toFixed(2),
    rebuild: true,
  },
];

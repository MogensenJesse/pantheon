...
This project is indexed by GitNexus as **pantheon** (2376 symbols, 6116 relationships, 192 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **pantheon** (2307 symbols, 5874 relationships, 186 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

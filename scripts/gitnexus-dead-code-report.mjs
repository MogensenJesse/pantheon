...
const REMOVED_SYMBOLS = [
  ...
  {
    name: 'packArmToOrm',
    file: 'packOrmTexture.ts',
    note: 'runtime full-pack deleted; bake script packs ORM',
  },
  { name: 'packRoughMrToOrm', file: 'packOrmTexture.ts', note: 'runtime full-pack deleted' },
  { name: 'normalizeDisplacementTexture', file: 'terrainDisplacement.ts' },
  { name: 'loadDisplacementTexture', file: 'terrainDisplacement.ts' },
  { name: 'probeDisplacementUrl', file: 'terrainDisplacement.ts' },
  { name: 'displacementCandidateUrls', file: 'loadTerrainGltfPack.ts' },
  { name: 'deriveMaterialPrefix', file: 'loadTerrainGltfPack.ts' },
  { name: 'getNeutralDisplacementTexture', file: 'terrainNeutralTextures.ts' },
  { name: 'getDefaultSpecTexture', file: 'terrainNeutralTextures.ts' },
  { name: 'isTerrainSharedNeutralTexture', file: 'terrainNeutralTextures.ts' },
  { name: 'TerrainBiomeMaps', file: 'terrainTextureTypes.ts' },
  { name: 'TerrainDetailConfig', file: 'terrainLodRings.ts' },
  {
    name: 'legacyTerrainMeshVertexCount',
